...
def exp(data: Any) -> Any:
    ...
    Example:
        ...
        {'a': array([[2.71828183e+00, 7.38905610e+00],
         ...
         'b': array([148.4131591 ,  54.59815003,  20.08553692,   7.3890561 , 2.71828183])}
...
def expm1(data: Any) -> Any:
    ...
    Example:
        ...
        {'a': array([[1.71828183e+00, 6.38905610e+00],
         ...
         'b': array([147.4131591 ,  53.59815003,  19.08553692,   6.3890561 , 1.71828183])}
...
def log(data: Any) -> Any:
    ...
    Example:
        ...
        {'a': array([[0.        , 0.69314718],
         ...
         'b': array([1.60943791, 1.38629436, 1.09861229, 0.69314718, 0.        ])}
...
def log2(data: Any) -> Any:
    ...
    Example:
        ...
        {'a': array([[0.        , 1.        ],
               ...
               [2.80735492, 3.        ],
               [3.169925  , 3.32192809]]),
         'b': array([2.32192809, 2.        , 1.5849625 , 1.        , 0.        ])}
...
def log10(data: Any) -> Any:
    ...
    Example:
        ...
        {'a': array([[0.        , 0.30103   ],
               ...
               [0.95424251, 1.        ]]),
         'b': array([0.69897   , 0.60205999, 0.47712125, 0.30103   , 0.        ])}
...
def log1p(data: Any) -> Any:
    ...
    Example:
        ...
        {'a': array([[0.69314718, 1.09861229],
         ...
         'b': array([1.79175947, 1.60943791, 1.38629436, 1.09861229, 0.69314718])}
