...
def arccos(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out
        {'a': array([[0., 0., 0.], [0., 0., 0.]]),
         'b': array([1.57079633, 0.        ,        nan,        nan,        nan])}
...
def arccosh(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out
        {'a': array([[0., 0., 0.], [0., 0., 0.]]),
         'b': array([       nan, 0.        , 1.3169579 , 1.76274717, 2.06343707])}
...
def arcsin(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = arcsin(data)
        >>> out
        {'a': array([[1.57079633, 1.57079633, 1.57079633], [1.57079633, 1.57079633, 1.57079633]]),
         'b': array([0.        , 1.57079633,        nan,        nan,        nan])}
...
def arcsinh(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = arcsinh(data)
        >>> out
        {'a': array([[0.88137359, 0.88137359, 0.88137359], [0.88137359, 0.88137359, 0.88137359]]),
         'b': array([0.        , 0.88137359, 1.44363548, 1.81844646, 2.09471255])}
...
def arctan(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = arctan(data)
        >>> out
        {'a': array([[0.78539816, 0.78539816, 0.78539816], [0.78539816, 0.78539816, 0.78539816]]),
         'b': array([0.        , 0.78539816, 1.10714872, 1.24904577, 1.32581766])}
...
def arctanh(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = arctanh(data)
        >>> out
        {'a': array([[0.54930614, 0.54930614, 0.54930614], [0.54930614, 0.54930614, 0.54930614]]),
         'b': array([-1.09861229, -0.42364893,  0.        ,  0.42364893,  1.09861229])}
    """
...
def cos(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = cos(data)
        >>> out
        {'a': array([[0.54030231, 0.54030231, 0.54030231], [0.54030231, 0.54030231, 0.54030231]]),
         'b': array([ 1.        ,  0.54030231, -0.41614684, -0.9899925 , -0.65364362])}
...
def cosh(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = cosh(data)
        >>> out
        {'a': array([[1.54308063, 1.54308063, 1.54308063], [1.54308063, 1.54308063, 1.54308063]]),
         'b': array([ 1.        ,  1.54308063,  3.76219569, 10.067662  , 27.30823284])}
...
def sin(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = sin(data)
        >>> out
        {'a': array([[0.84147098, 0.84147098, 0.84147098], [0.84147098, 0.84147098, 0.84147098]]),
         'b': array([ 0.        ,  0.84147098,  0.90929743,  0.14112001, -0.7568025 ])}
...
def sinh(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = sinh(data)
        >>> out
        {'a': array([[1.17520119, 1.17520119, 1.17520119], [1.17520119, 1.17520119, 1.17520119]]),
         'b': array([ 0.        ,  1.17520119,  3.62686041, 10.01787493, 27.2899172 ])}
...
def tan(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = tan(data)
        >>> out
        {'a': array([[1.55740772, 1.55740772, 1.55740772], [1.55740772, 1.55740772, 1.55740772]]),
         'b': array([ 0.        ,  1.55740772, -2.18503986, -0.14254654,  1.15782128])}
...
def tanh(data: Any) -> Any:
    ...
    Example:
        ...
        >>> out = tanh(data)
        >>> out
        {'a': array([[0.76159416, 0.76159416, 0.76159416], [0.76159416, 0.76159416, 0.76159416]]),
         'b': array([0.        , 0.76159416, 0.96402758, 0.99505475, 0.9993293 ])}
